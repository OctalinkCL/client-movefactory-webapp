  ...
  <div class="flex items-center justify-center p-4">
    <div class="w-full max-w-sm space-y-8">
      ...
      <div class="flex flex-col items-center">
        <div
          class="rounded-full bg-linear-to-t from-sky-500/0 to-yellow-500/30 p-3"
        >
          <div
            class="size-12 rounded-full bg-white border border-yellow-300 flex items-center justify-center"
          >
            <User :size="24" :stroke-width="1.5" class="text-yellow-500" />
          </div>
        </div>
        <h1 class="text-2xl font-medium text-mist-950">
          Bienvenido a Move<span class="font-bold">Factory</span>
        </h1>
