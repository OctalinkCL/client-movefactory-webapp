...
import { Home, UtensilsCrossed, UserRound, FileText, Gift } from 'lucide-vue-next'
...
const navItems = [
  ...
  { name: 'Beneficios', to: 'user-benefits', icon: Gift },
...
<template>
  <footer class="sticky bottom-0 lg:hidden bg-background border-t z-50">
    <nav class="flex">
      <button
        ...
        :class="route.name === item.to ? 'text-foreground' : 'text-muted-foreground'"
      >
